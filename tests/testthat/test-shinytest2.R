...
test_that("Test app on bullets in meters", {
...
test_that("Test app on bullets already in microns", {
  ...
  # Select Bullet 1 Land x3p Files button ----
  files1 <- list.files(testthat::test_path("fixtures", "hamby44_mum", "barrel1", "bullet2"), full.names = TRUE, pattern = ".x3p")
  app$upload_file(upload_button = files1)
  app$wait_for_idle()
  app$expect_values(export = TRUE, input = inputs)  # 3
  ...
  # Select Bullet 2 Land x3p Files button ----
  files2 <- list.files(testthat::test_path("fixtures", "hamby44_mum", "barrel1", "bullet2"), full.names = TRUE, pattern = ".x3p")
  app$upload_file(upload_button = files2)
  app$wait_for_idle()
  app$expect_values(export = TRUE, input = inputs)  # 5
